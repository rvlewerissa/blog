...
const navigation = {
  'Social Media': [
    { name: 'Github', href: 'https://github.com/rvlewerissa' },
  ...
  social: [
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/VittoLewerissa',
      icon: (props: IconProps) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/vittolewerissa/',
      icon: (props: IconProps) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
          <path
            fillRule='evenodd'
...
export default function Footer() {
  return (
    <footer className='bg-gray-800' aria-labelledby='footer-heading'>
      ...
      <div className='mt-8 p-8 border-t border-gray-700 md:flex md:items-center md:justify-end'>
